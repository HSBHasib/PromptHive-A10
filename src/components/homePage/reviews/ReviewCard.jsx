...
const ReviewCard = ({ review, idx }) => {
  const { rating, comment, userName, userImage, createdAt } = review || {};
    ...
    >
      ...
      <div className="flex items-center justify-between w-full mt-auto pt-4 border-t border-[#86707020]">
        ...
        <span
          ...
          aria-label={`Feedback statement submitted timestamp marker is ${createdAt}`}
        >
