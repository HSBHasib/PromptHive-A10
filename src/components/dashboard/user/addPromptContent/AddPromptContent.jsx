    ...
    <div className="w-full max-w-3xl mx-auto bg-[#F5EBEB]/60 border border-[#86707020] rounded-3xl p-6 lg:p-10 shadow-sm text-[#867070]">
      ...
      <div className="mb-6 bg-[#86707020] border border-[#86707020] rounded-xl p-4 flex items-center justify-between text-xs font-semibold text-[#867070]">
        <div className="flex items-center gap-2">
          ...
          {isCreator ? (
            <p>
              You are a{" "}
              <span className="text-[#6B5656] font-bold">Creator</span>:
              Unlimited prompts allowed!
            </p>
          ) : isPro ? (
            <p>
              You are on{" "}
              <span className="text-[#6B5656] font-bold">Pro Plan</span>:
              Unlimited prompts allowed!
            </p>
          ) : (
            <p className="font-bold">
              Used: {currentPrompts} / {maxLimit} | Remaining:{" "}
              <span className="text-[#6B5656] font-black">
      ...
      {!canAdd && isUser ? (
        <div className="text-center py-12 border-2 border-dashed border-[#86707030] rounded-2xl bg-white/50">
          ...
          <p className="mb-6">
            You have used up all your free prompts ({currentPrompts}/{maxLimit}
            ). Upgrade to Pro for unlimited access.
          </p>
          <a
            href="/payments"
            className="bg-[#867070] text-white px-8 py-3 rounded-xl font-bold hover:bg-[#6B5656] transition"
          >
            Upgrade to Pro
          </a>
        </div>
