...
const PromptDetails = ({ prompt, creator }) => {
  return (
      ...
      <div className="space-y-4">
        ...
        <div className="flex justify-between items-center ">
          <span className="text-stone-500 flex items-center gap-2">
            <LuGauge size={16} /> Difficulty
          </span>
          <span className="text-sm font-bold capitalize py-1 rounded bg-stone-100 text-stone-600">
